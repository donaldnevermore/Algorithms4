...
public class ST<Key extends Comparable<Key>, Value> implements Iterable<Key> {
     ...
     * the key is in this symbol table). This is equivalent to {@code remove()}, but
     * we plan to deprecate {@code delete()}.
     *
     * @param key the key
     * @throws IllegalArgumentException if {@code key} is {@code null}
     */
    ...
    /**
     * Removes the specified key and its associated value from this symbol table (if
     * the key is in this symbol table). This is equivalent to {@code delete()}, but
     * we plan to deprecate {@code delete()}.
     *
     * @param key the key
     * @throws IllegalArgumentException if {@code key} is {@code null}
